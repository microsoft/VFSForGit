...
dotnet %VFS_OUTPUTDIR%\GVFS.FunctionalTests\bin\x64\%Configuration%\netcoreapp2.1\GVFS.FunctionalTests.dll /result:TestResultXplat.xml %2 %3 %4 %5 || goto :endFunctionalTests
%VFS_OUTPUTDIR%\GVFS.FunctionalTests.Windows\bin\x64\%Configuration%\GVFS.FunctionalTests.Windows.exe /result:TestResultWindows.xml --windows-only %2 %3 %4 %5 || goto :endFunctionalTests
