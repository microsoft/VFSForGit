...
bool GVFlt_MoveFile_NoneToNone(const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_MoveFile_VirtualToVirtual(const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_MoveFile_VirtualToPartial(const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_MoveFile_LocalToVirtual(const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_MoveFile_VirtualToVirtualIntermidiateDirNotExist(const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_MoveFile_VirtualToNoneIntermidiateDirNotExist(const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_MoveFile_OutsideToPartial(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_MoveFile_VirtualToOutside(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_MoveFile_OutsideToOutside(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
