...
bool GVFlt_SetLink_ToVirtualFile(const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_SetLink_ToFullFile(const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_SetLink_ToNonExistFileWillFail(const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_SetLink_ToOutside(const char* pathOutsideRepo, const char* virtualRootPath)
{
    try
    {
