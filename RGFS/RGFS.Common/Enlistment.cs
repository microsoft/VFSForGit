...
namespace RGFS.Common
{
    ...
    {
        private const string DeprecatedObjectsEndpointGitConfigName = "rgfs.objects-endpoint";
            ...
            string rgfsHooksRoot)
        {
            ...
            this.DotGitRoot = Path.Combine(this.WorkingDirectoryRoot, RGFSConstants.DotGit.Root);
            this.GitBinPath = gitBinPath;
            this.RGFSHooksRoot = rgfsHooksRoot;
        ...
        public string RGFSHooksRoot { get; }
