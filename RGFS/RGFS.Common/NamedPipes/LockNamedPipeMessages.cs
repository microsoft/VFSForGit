...
{
    /// <summary>
    /// Define messages used to communicate via the named-pipe in RGFS.
    /// </summary>
    /// <remarks>
    /// This file contains only the message types that RGFS.Hooks is interested
    /// in using. For all other messages see RGFS.Common/NamedPipeMessages.
    /// </remarks>
    public static partial class NamedPipeMessages
    {
        ...
        public static class AcquireLock
        {
            ...
            public const string DenyRGFSResult = "LockDeniedRGFS";
