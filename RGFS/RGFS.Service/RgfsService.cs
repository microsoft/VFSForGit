...
{
    public class RGFSService : ServiceBase
    {
        private const string ServiceNameArgPrefix = "--servicename=";
        private const string EtwArea = nameof(RGFSService);
        ...
        public RGFSService(JsonEtwTracer tracer)
        {
            this.tracer = tracer;
        ...
        protected override void OnSessionChange(SessionChangeDescription changeDescription)
        {
            try
            {
                ...
                if (!RGFSEnlistment.IsUnattended(tracer: null))
                {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            this.tracer.AddLogFileEventListener(
                RGFSEnlistment.GetNewRGFSLogFileName(Paths.GetServiceLogsPath(this.serviceName), RGFSConstants.LogFileTypes.Service),
                EventLevel.Verbose,
                Keywords.Any);
