...
namespace RGFS.FunctionalTests.Tests.GitCommands
{
    ...
    public class UpdateIndexTests : GitRepoTests
    {
        ...
        public void UpdateIndexRemoveFileOnDiskDontCheckStatus()
        {
            ...
            GitHelpers.InvokeGitAgainstRGFSRepo(this.Enlistment.RepoRoot, "update-index --remove Test_ConflictTests/AddedFiles/AddedByBothDifferentContent.txt");
            this.FilesShouldMatchCheckoutOfTargetBranch();
            ...
            GitHelpers.InvokeGitAgainstRGFSRepo(this.Enlistment.RepoRoot, "update-index --add Test_ConflictTests/AddedFiles/AddedByBothDifferentContent.txt");
        }
