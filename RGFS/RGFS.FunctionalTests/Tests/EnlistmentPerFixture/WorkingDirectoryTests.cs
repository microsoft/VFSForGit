...
";
        ...
        {
            string filePath = "RGFS\\FastFetch\\Properties\\AssemblyInfo.cs";
        ...
        public void AllNullObjectRedownloaded()
        {
            ...
            string corruptObjectFolderPath = Path.Combine(this.Enlistment.DotRGFSRoot, "CorruptObjects");
        ...
        private class NativeTests
        {
            ...
            [DllImport("RGFS.NativeTests.dll", CharSet = CharSet.Ansi)]
