...
namespace RGFS.FunctionalTests.Tests.EnlistmentPerFixture
{
    ...
    public class GitFilesTests : TestsWithEnlistmentPerFixture
    {
        ...
        {
            string gitFileToCheck = "RGFS/RGFS.FunctionalTests/Category/CategoryConstants.cs";
        ...
        {
            string fileToTest = "RGFS\\RGFS.Common\\RetryWrapper.cs";
            ...
            ManualResetEventSlim resetEvent = GitHelpers.AcquireRGFSLock(this.Enlistment);
        ...
        [DllImport("RGFS.NativeTests.dll", CharSet = CharSet.Unicode)]
