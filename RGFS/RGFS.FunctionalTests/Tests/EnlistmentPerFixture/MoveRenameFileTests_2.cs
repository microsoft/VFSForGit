...
%~dp0\..\..\BuildOutput\RGFS.UnitTests\bin\x64\%Configuration%\RGFS.UnitTests.exe";
...
%~dp0\..\..\BuildOutput\RGFS.FunctionalTests\bin\x64\%Configuration%\RGFS.FunctionalTests.exe %2";
        ...
        // This test needs the RGFS folder to not exist on physical disk yet, so run it first
        [TestCase, Order(1)]
        public void MoveUnhydratedFileToUnhydratedFolderAndWrite()
        {
            ...
            // Assume there will always be a RGFS folder when running tests
            string testFolderName = "RGFS";
