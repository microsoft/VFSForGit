...
namespace RGFS.FunctionalTests.Tests.EnlistmentPerFixture
{
    ...
    public class GitMoveRenameTests : TestsWithEnlistmentPerFixture
    {
        ...
        public void GitStatusAndObjectAfterGitAdd()
        {
            ...
            ProcessResult result = GitHelpers.InvokeGitAgainstRGFSRepo(
                this.Enlistment.RepoRoot,
        ...
        public void GitWithEnvironmentVariables()
        {
            ...
            ProcessResult result = GitHelpers.InvokeGitAgainstRGFSRepo(this.Enlistment.RepoRoot, "branch", cleanErrors: false);
