...
{
    public static class RGFSServiceProcess
    {
        public const string TestServiceName = "Test.RGFS.Service";
        ...
        public static void UninstallService()
        {
            ...
            string serviceData = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), "RGFS", TestServiceName);
