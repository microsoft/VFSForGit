...
namespace RGFS.UnitTests.Mock.FileSystem
{
    public class MockDirectory
    {
        ...
        {
            string parentPath = path.Substring(0, path.LastIndexOf(RGFSConstants.PathSeparator));
        ...
        {
            int lastSlashIdx = path.LastIndexOf(RGFSConstants.PathSeparator);
        ...
        public void MoveDirectory(string sourcePath, string targetPath)
        {
            ...
            int endPathIndex = targetPath.LastIndexOf(RGFSConstants.PathSeparator);
