...
namespace RGFS.UnitTests.Common
{
    ...
    public class JsonEtwTracerTests
    {
        ...
        {
            using (JsonEtwTracer tracer = new JsonEtwTracer("Microsoft-RGFS-Test", "EventsAreFilteredByVerbosity1", useCriticalTelemetryFlag: false))
            ...
            using (JsonEtwTracer tracer = new JsonEtwTracer("Microsoft-RGFS-Test", "EventsAreFilteredByVerbosity2", useCriticalTelemetryFlag: false))
        ...
        public void EventsAreFilteredByKeyword()
        {
            ...
            using (JsonEtwTracer tracer = new JsonEtwTracer("Microsoft-RGFS-Test", "EventsAreFilteredByKeyword1", useCriticalTelemetryFlag: false))
            ...
            using (JsonEtwTracer tracer = new JsonEtwTracer("Microsoft-RGFS-Test", "EventsAreFilteredByKeyword2", useCriticalTelemetryFlag: false))
            using (MockListener listener = new MockListener(EventLevel.Verbose, Keywords.Any))
            {
                tracer.AddInProcEventListener(listener);
            ...
            using (JsonEtwTracer tracer = new JsonEtwTracer("Microsoft-RGFS-Test", "EventsAreFilteredByKeyword3", useCriticalTelemetryFlag: false))
