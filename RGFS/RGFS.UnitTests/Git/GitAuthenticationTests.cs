...
namespace RGFS.UnitTests.Git
{
    ...
    public class GitAuthenticationTests
    {
        ...
        private MockGitProcess GetGitProcess()
        {
            ...
            gitProcess.SetExpectedCommandResult("config rgfs.FunctionalTests.UserName", () => new GitProcess.Result(string.Empty, string.Empty, GitProcess.Result.GenericFailureCode));
            gitProcess.SetExpectedCommandResult("config rgfs.FunctionalTests.Password", () => new GitProcess.Result(string.Empty, string.Empty, GitProcess.Result.GenericFailureCode));
