...
namespace FastFetch.Git
{
    public class GitIndexGenerator
    {
        ...
        public GitIndexGenerator(ITracer tracer, Enlistment enlistment, bool shouldHashIndex)
        {
            ...
            this.indexLockPath = Path.Combine(enlistment.DotGitRoot, RGFSConstants.DotGit.IndexName + RGFSConstants.DotGit.LockExtension);
        }
        ...
        private class LsTreeEntry
        {
            ...
            public static LsTreeEntry ParseFromLsTreeLine(string line)
            {
                ...
                if (blobIndex >= 0)
                {
                    ...
                    blobEntry.Sha = line.Substring(blobIndex + DiffTreeResult.BlobMarker.Length, RGFSConstants.ShaStringLength);
