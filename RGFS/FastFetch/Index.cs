...
namespace FastFetch
{
    public class Index
    {
            ...
            bool readOnly)
        {
            ...
            {
                this.updatedIndexPath = Path.Combine(repoRoot, RGFSConstants.DotGit.Root, UpdatedIndexName);
            }

            this.versionMarkerFile = Path.Combine(this.repoRoot, RGFSConstants.DotGit.Root, ".fastfetch", "VersionMarker");
        }
