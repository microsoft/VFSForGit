#include "stdafx.h"
#include "GVFlt_MoveFolderTest.h"
...
bool GVFlt_MoveFolder_NoneToNone(const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_MoveFolder_VirtualToNone(const char* virtualRootPath)
{
    try
    {
