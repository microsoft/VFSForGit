#include "stdafx.h"
#include "GVFlt_FileAttributeTest.h"
...
bool GVFlt_ModifyFileInScratchAndCheckLastWriteTime(const char* virtualRootPath)
{
    try
    {
        ...
        // NOTE: This is slightly different than the validate in GVFlt, which tests if the scratch time is different than the layer time
...
bool GVFlt_ModifyFileInScratchAndCheckFileSize(const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_FileAttributes(const char* virtualRootPath)
{
    try
    {
