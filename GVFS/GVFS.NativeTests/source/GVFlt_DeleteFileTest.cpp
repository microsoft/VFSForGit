#include "stdafx.h"
#include "GVFlt_DeleteFileTest.h"
...
bool GVFlt_DeleteVirtualFile_SetDisposition(const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_DeleteLocalFile_DeleteOnClose(const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_DeleteNotExistFile_SetDisposition(const char* virtualRootPath)
{
    try
    {
...
bool GVFlt_DeleteFileOutsideVRoot_SetDisposition(const char* pathOutsideRepo)
{
    try
    {
...
bool GVFlt_DeleteFileOutsideVRoot_DeleteOnClose(const char* pathOutsideRepo)
{
    try
    {
