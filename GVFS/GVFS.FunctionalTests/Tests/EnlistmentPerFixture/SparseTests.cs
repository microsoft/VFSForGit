...
namespace GVFS.FunctionalTests.Tests.EnlistmentPerFixture
{
    ...
    public class SparseTests : TestsWithEnlistmentPerFixture
    {
        ...
        public void GitStatusShouldRunWithFilesChangedInSparseSet()
        {
            ...
            string modifiedPath = Path.Combine(this.Enlistment.RepoRoot, "GVFS", "GVFS", "Program.cs");
            string firstFileToDeletePath = Path.Combine(pathToChangeFiles, "CloneHelper.cs");
            string secondFileToDeletePath = Path.Combine(pathToChangeFiles, "DiagnoseVerb.cs");
            this.fileSystem.WriteAllText(modifiedPath, "New Contents");
            this.fileSystem.WriteAllText(Path.Combine(pathToChangeFiles, "NewHelper.cs"), "New Contents");
            this.fileSystem.DeleteFile(firstFileToDeletePath);
            ...
            this.fileSystem.DeleteFile(secondFileToDeletePath);
            ...
            firstFileToDeletePath.ShouldNotExistOnDisk(this.fileSystem);
            secondFileToDeletePath.ShouldNotExistOnDisk(this.fileSystem);

            string interimStatusOutput = GitProcess.Invoke(this.Enlistment.RepoRoot, "status --porcelain -uall");
            interimStatusOutput.ShouldEqual(expectedStatusOutput, "Status output should not change.");
