...
namespace GVFS.FunctionalTests.Tests.EnlistmentPerFixture
{
    ...
    public class GitCommandsTests : TestsWithEnlistmentPerFixture
    {
        ...
        public void DeleteFolderAndChangeBranchToFolderWithDifferentCase()
        {
            ...
            // 92104900921570b36efdd4f29288e3f57e0e7da7 is the commit prior to deleting GVFLT_MultiThreadTest 
            // and re-adding it as as GVFlt_MultiThreadTest
            this.ValidateGitCommand("checkout 92104900921570b36efdd4f29288e3f57e0e7da7");
            this.FolderShouldHaveCaseMatchingName(folderName, "GVFLT_MultiThreadTest");
        ...
        {
            this.ValidateGitCommand("status");
            this.ReplaceText(TestConstants.DotGit.Head, "7481fc4f61894638b00e88b77b0b4ffd8d7e16e6");
            this.ValidateGitCommand("status");
        }
        ...
        public void ResetSoftTwice()
        {
            ...
            this.ValidateGitCommand("reset --soft 1973ec15b70273d8d46448bf842b4973b7402255");
            this.ValidateGitCommand("reset --soft ab438d5782f6ef9584769362a9877c23eb2d970e");
        }
        ...
        public void ResetMixedTwice()
        {
            ...
            // A folder rename occured between ab438d5782f6ef9584769362a9877c23eb2d970e and 
            // the subsequent commit 1973ec15b70273d8d46448bf842b4973b7402255
            this.ValidateGitCommand("reset --mixed 1973ec15b70273d8d46448bf842b4973b7402255");
            this.ValidateGitCommand("reset --mixed ab438d5782f6ef9584769362a9877c23eb2d970e");
        }
        ...
        public void ResetMixed2Twice()
        {
            ...
            // A folder rename occured between ab438d5782f6ef9584769362a9877c23eb2d970e and 
            // the subsequent commit 1973ec15b70273d8d46448bf842b4973b7402255
            this.ValidateGitCommand("reset 1973ec15b70273d8d46448bf842b4973b7402255");
            this.ValidateGitCommand("reset ab438d5782f6ef9584769362a9877c23eb2d970e");
        }
