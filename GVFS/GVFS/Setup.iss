...
#define GVFltRelative "..\..\..\..\..\packages\GVFS.GVFlt.2017.129.1\filter"
#define CppDependancyRelative "..\..\..\..\..\packages\GVFS.CppBinaryDependancy.1.0.2\lib"
...
[Files]
; Call UninstallOldFS before the installation of the first file so that anything that needs to be uninstalled can be
; uninstalled using the GVFS that is currently installed
; GVFlt Files
DestDir: "{app}\Filter"; Flags: ignoreversion; Source:"{#GVFltRelative}\gvflt.pdb"; BeforeInstall: UninstallOldFS
...
; Cpp Dependancies
DestDir: "{app}"; Flags: ignoreversion; Source:"{#CppDependancyRelative}\ucrtbase.dll"
DestDir: "{app}"; Flags: ignoreversion; Source:"{#CppDependancyRelative}\msvcp140.dll"
DestDir: "{app}"; Flags: ignoreversion; Source:"{#CppDependancyRelative}\vcruntime140.dll"
