...
namespace GVFS.DiskLayoutUpgrades
{
    public abstract class DiskLayoutUpgrade
    {
        ...
        private static readonly Dictionary<int, MajorUpgrade> MajorVersionUpgrades =
        ...
        private static readonly Dictionary<int, Dictionary<int, MinorUpgrade>> MinorVersionUpgrades =
            new Dictionary<int, Dictionary<int, MinorUpgrade>>
            {
                { 12, BuildMinorUpgradeDictionary(new DiskLayout12_0To12_1Upgrade()) },
            };
        ...
        private static Dictionary<int, MajorUpgrade> BuildMajorUpgradeDictionary(params MajorUpgrade[] upgraders)
        {
            return upgraders.ToDictionary(
                upgrader => upgrader.SourceMajorVersion,
                upgrader => upgrader);
        }

        private static Dictionary<int, MinorUpgrade> BuildMinorUpgradeDictionary(params MinorUpgrade[] upgraders)
        {
            return upgraders.ToDictionary(
                upgrader => upgrader.SourceMinorVersion,
                upgrader => upgrader);
        }
