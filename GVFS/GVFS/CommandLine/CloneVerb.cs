...
namespace GVFS.CommandLine
{
    ...
    public class CloneVerb : GVFSVerb
    {
            ...
            string branch)
        {
            ...
            File.WriteAllText(
                Path.Combine(enlistment.StorageRoot, GVFSConstants.DotGit.Head),
            ...
            if (!GVFSPlatform.Instance.KernelDriver.TryPrepareFolderForCallbacks(enlistment.StorageRoot, out prepFileSystemError, out exception))
            {
                EventMetadata metadata = new EventMetadata();
...
");
        ...
        {
            string repoPath = enlistmentToInit.StorageRoot;
