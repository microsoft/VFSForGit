  ...
  if HasMounts then
    begin
      if WizardSilent() then
        begin
          // Silent mode: KEEPMOUNTED param controls behavior (default: true when mounts exist)
          KeepMountsRunning := ExpandConstant('{param:KEEPMOUNTED|true}') = 'true';
        ...
        begin
          ...
          MsgBoxResult := SuppressibleMsgBox(
            ...
            'The upgrade will complete automatically on next reboot.' + #13#10#13#10 +
