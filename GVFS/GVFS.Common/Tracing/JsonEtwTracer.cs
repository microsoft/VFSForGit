...
namespace GVFS.Common.Tracing
{
    public class JsonEtwTracer : ITracer
    {
        ...
        private const string EngineeringSystemsProviderGroup = "{4f50731a-89cf-4782-b3e0-dce8c90476ba}";
        ...
        public JsonEtwTracer(string providerName, string activityName)
            : this(
                  new EventSource(providerName, EventSourceSettings.EtwSelfDescribingEventFormat, new string[] { "ETW_GROUP", EngineeringSystemsProviderGroup }),
                  Guid.Empty,
                  activityName,
