    ...
    public abstract class DiskLayoutUpgrade
    {
        ...
        public static bool TryCheckDiskLayoutVersion(ITracer tracer, string enlistmentRoot, out string error)
        {
            ...
            try
            {
                ...
                {
                    if (majorVersion < GVFSPlatform.Instance.DiskLayout.MinimumSupportedMajorVersion)
                    {
                        error = string.Format(
                            ...
                            GVFSPlatform.Instance.DiskLayout.MinimumSupportedMajorVersion);

                        return false;
                    }
                    else if (majorVersion > GVFSPlatform.Instance.DiskLayout.CurrentMajorVersion)
                    {
                        error = string.Format(
                    ...
                    else if (majorVersion != GVFSPlatform.Instance.DiskLayout.CurrentMajorVersion)
                    {
                        error = string.Format(
                            ...
                            minorVersion,
                            GVFSPlatform.Instance.DiskLayout.CurrentMajorVersion,
                            GVFSPlatform.Instance.DiskLayout.CurrentMinorVersion);
