    ...
    public partial class GVFSEnlistment : Enlistment
    {
        ...
        public GVFSEnlistment(string enlistmentRoot, string repoUrl, string gitBinPath, string gvfsHooksRoot, GitAuthentication authentication)
            : base(
                  ...
                  Path.Combine(enlistmentRoot, GVFSPlatform.Instance.Constants.StoragePath),
                  repoUrl,
                  gitBinPath,
                  gvfsHooksRoot,
                  ...
                  authentication: authentication)
        {
            ...
            this.LocalObjectsRoot = Path.Combine(this.StorageRoot, GVFSConstants.DotGit.Objects.Root);
        }
