...
namespace GVFS.UnitTests.Windows.Virtualization
{
    ...
    public class WindowsFileSystemVirtualizerTests : TestsWithCommonRepo
    {
        ...
        private static void AssertRepairFailedWithReason(MockTracer mockTracker, string expectedReason)
        {
            ...
            mockTracker.RelatedEventMetadataSerialized[index].Contains(expectedReason).ShouldBeTrue(
                $"Expected RepairFailedReason '{expectedReason}' in the repair-failed event metadata, was: {mockTracker.RelatedEventMetadataSerialized[index]}");
        }
