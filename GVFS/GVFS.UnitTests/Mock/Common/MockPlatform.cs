...
namespace GVFS.UnitTests.Mock.Common
{
    ...
    {
        public MockPlatform()
            : base(executableExtension: ".mockexe", installerExtension: ".mockexe", underConstruction: new UnderConstructionFlags(), diskLayoutVersion: new DiskLayoutVersion(0, 0, 0))
        {
        }
