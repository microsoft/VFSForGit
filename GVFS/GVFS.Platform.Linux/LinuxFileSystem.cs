...
namespace GVFS.Platform.Linux
{
    public partial class LinuxFileSystem : IPlatformFileSystem
    {
        ...
        private static class NativeStat
        {
            ...
            // TODO(Linux): Field order and padding may vary with arch!
            ...
            public struct StatBuffer
            {
                ...
                public long ATime;       /* last access (sec portion) */
                public long MTime;       /* last modification (sec portion) */
                public long CTime;       /* last status change (sec portion) */
                public long ATimeNsec;   /* last access (nsec portion) */
                public long MTimeNsec;   /* last modification (nsec portion) */
                public long CTimeNsec;   /* last status change (nsec portion) */
            }
        }
