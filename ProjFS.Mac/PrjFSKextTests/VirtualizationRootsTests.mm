...
- (void) testDirectoryContainsPath
{
    XCTAssertTrue(DirectoryContainsPath("/some/directory", "/some/directory/containing/file"));
    XCTAssertTrue(DirectoryContainsPath("/directory/with/slash/", "/directory/with/slash/containing/file"));
    XCTAssertTrue(DirectoryContainsPath("/", "/below/root/directory"));
    XCTAssertTrue(DirectoryContainsPath("/a/directory/itself", "/a/directory/itself"));

     XCTAssertFalse(DirectoryContainsPath("/some/dir", "/some/directory/containing/file"));
    XCTAssertFalse(DirectoryContainsPath("/a/directory", "/a/dir"));
    XCTAssertFalse(DirectoryContainsPath("/some/directory/with/sub/directories", "/some/directory"));
}
